            ...
            <div class="col-md-10 column">
                <div style="float: left; width: 20%">
                    <ul class="list-group" id="homepageUl" style="border: 1px solid #dddddd;">
                        ...
                        <a href="javascript:void(0);" onclick="myHand()" class="list-group-item active"><span class="glyphicon glyphicon-picture">&nbsp;我的头像</span></a>
                ...
                <div style="float: right; width: 80%;height: 620px; border: 1px solid #dddddd;">
                    <div style="width: 100%; height: 49px;padding-top:0px; border-bottom: 1px solid #dddddd;">
                        ...
                        <span style="float: left; color: rgb(63, 164, 247);margin-top: 15px;margin-left: 5px;">我的头像</span>
                    </div>

                    <div style="margin-top: 20px;">
                        <div style="width: 200px; height: 200px; margin: 0 auto; border-radius: 50%; border: 1px solid #dddddd;">
                            <img style=" height: 50%; width: 50%; margin-top: 50px; margin-left: 50px; border-radius: 50%; "src="../../static/img/img7.png">
                            <a href="#">
                        ...
                        <div style="margin-top: 20px;">
                            <div class="col-sm-6 col-md-3" >
                                <a href="#" class="thumbnail" style="border-radius: 50%;">
                                    <img style="width: 150px;height: 150px; border-radius: 50%;" src="../../static/img/img7.png">
                                </a>

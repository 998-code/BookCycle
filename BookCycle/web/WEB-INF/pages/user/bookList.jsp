       ...
       $(function () {
           ...
           $(".endowCancel").click(function () {
               ...
               if(status!="待处理"&&status!="处理中"){
                   ...
                   if(confirm("你确定取消书单["+bookListId+"]吗？")){
                       $.post({
                           url:"${pageContext.request.contextPath}/endowBookList/cancel",
                           data:{"bookListId":bookListId},
                           success:function (data) {
                               if(data){
                                   ul.children("td").eq(3).text("已取消");
           ...
           $(".details").click(function () {
               ...
               $("#status").text(status);
               $.post({
                   url:"${pageContext.request.contextPath}/details/bookList",
                   data:{"bookListId":bookListId},
                   success:function (data) {
                       var html="";
           ...
           $(".endowDetails").click(function () {
               ...
               $.post({
                   url:"${pageContext.request.contextPath}/details/endowBookList",
                   data:{"bookListId":bookListId},
                   success:function (data) {
                       var html="";
                       for (var i = 0; i <data.length ; i++) {
            ...
            <div class="col-md-10 column">
                <div style="float: left; width: 20%">
                    <ul class="list-group" id="homepageUl" style="border: 1px solid #dddddd;">
                        ...
                        <a href="javascript:void(0);" onclick="myBookList()" class="list-group-item active"><span class="glyphicon glyphicon-book">&nbsp;我的书单</span></a>
                ...
                <div style="float: right; width: 80%;height: 620px; border: 1px solid #dddddd;">
                    <div style="width: 100%; height: 49px;padding-top:0px; border-bottom: 1px solid #dddddd;">
                        ...
                        <div style="border:1px solid rgb(63, 164, 247);float: right;margin-right: 20%; margin-top:15px ;border-radius: 5px;padding-left:15px ;padding-right: 15px;">
                            <a href="javascript:void(0);" onclick="myBookList()"><span style="color: rgb(63, 164, 247);line-height: normal;">我要捐书</span></a>
                        </div>
                    </div>
                    <!-- 借书单 -->
                            ...
                            <tbody>
                                <c:forEach items="${sessionScope.bookLists}" var="bookList">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="details" data-toggle="modal" data-target="#details">详情</a> |
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li><a href="javascript:void(0);" id="cancelBorrowing">取消借阅</a></li>
                                                                    <li><a href="javascript:void(0);" id="confirmReceipt">确认接收</a></li>
                                                                </ul>
                                                            </div>
                                                        </td>
                                                    </tr>
                    ...
                    <div>
                            ...
                            <tbody>
                                <c:forEach items="${sessionScope.endowBookLists}" var="endowBookList">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="endowDetails" data-toggle="modal" data-target="#endowDetails">详情</a> |
                        ...
                        <!-- 模态框（Modal） -->
                        <div class="modal fade" id="endowDetails" tabindex="-1" role="dialog" aria-labelledby="endowDetailsLabel" aria-hidden="true" >
                            <div class="modal-dialog" style="width: 60%;">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>

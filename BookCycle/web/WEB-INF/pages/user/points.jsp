                ...
                <div style="float: right; width: 80%;height: 620px; border: 1px solid #dddddd;">
                    ...
                    <div >
                        ...
                        <div style="width: 60%;float: left;margin-left: 10px;">
                                ...
                                <tbody>
                                    <c:forEach items="${sessionScope.points}" var="points">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0);" class="pointsDetails" data-toggle="modal" data-target="#pointsDetailsModal">详情</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            ...
                            <!-- 模态框（Modal） -->
                            <div class="modal fade" id="pointsDetailsModal" tabindex="-1" role="dialog" aria-labelledby="pointsDetailsLabel" aria-hidden="true" >

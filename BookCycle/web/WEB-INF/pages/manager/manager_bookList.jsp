                    ...
                    <tbody>
                        <c:forEach items="${requestScope.bookListPage.pageItems}" var="bookList">
                            <tr>
                                ...
                                <td>借书单</td>
                                <td>
                                    <a href="javascript:void(0);" class="details" data-book-list-id="${bookList.bookListId}" data-toggle="modal" data-target="#details">
                                        详情
                                    </a>
                                </td>
                                <td>
                                    <a href="javascript:void(0);" class="outOfStock" data-book-list-id="${bookList.bookListId}" data-status="${bookList.status}">
                                        确认出库
                                    </a> |
                                    <a href="javascript:void(0);" class="confirmReturn" data-book-list-id="${bookList.bookListId}" data-status="${bookList.status}">
                                        确认归还
                                    </a>
                                </td>
                            </tr>
